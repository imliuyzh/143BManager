# ICSOSProcessManager
A simple process and resource manager. It provides the basic operations to create and destroy processes, and to request and release resources. A manually invoked timeout function mimics the behavior of preemptive scheduling. 
