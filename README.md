# [ICSOS-Process-Manager](https://github.com/imliuyzh/ICSOS-Process-Manager)
A simple process and resource manager provides the basic operations invoked by processes to create and destroy processes, and to request and release resources.
